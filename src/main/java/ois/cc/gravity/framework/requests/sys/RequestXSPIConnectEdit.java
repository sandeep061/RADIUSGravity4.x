...
public class RequestXSPIConnectEdit extends Request
{

    @Param(Optional = false)
    private String XSPIConnectId;
    ...
    public RequestXSPIConnectEdit(String requestid)
    {
        super(requestid, GReqType.Control, GReqCode.XSPIConnectEdit);
    }
    ...
    public String getXSPIConnectId()
    {
        return XSPIConnectId;
    }

    public void setXSPIConnectId(String XSPIConnectId)
    {
        this.XSPIConnectId = XSPIConnectId;
    }

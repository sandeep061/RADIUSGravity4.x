...
public class RequestXSPIConnectConfig extends Request
{
    ...
    public RequestXSPIConnectConfig(String requestid)
    {
        super(requestid, GReqType.Control, GReqCode.XSPIConnectConfig);
    }

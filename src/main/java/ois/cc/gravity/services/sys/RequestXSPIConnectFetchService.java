...
public class RequestXSPIConnectFetchService extends ARequestEntityService
{

    public RequestXSPIConnectFetchService(UAClient uac)
    {
        super(uac);
    }
    ...
    protected Event DoProcessEntityRequest(Request request) throws Throwable
    {
        ...
        try
        {
            XSPIConnectQuery enQry = new XSPIConnectQuery();

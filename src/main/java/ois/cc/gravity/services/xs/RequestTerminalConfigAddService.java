...
public class RequestTerminalConfigAddService extends RequestEntityAddService
{

    public RequestTerminalConfigAddService(UAClient uac)
    {
        super(uac);
    }
...
//        }
        Long tid = req.getAttributeValueOf(Long.class, "Terminal");
        _tctx.getDB().FindAssert(EN.Terminal.getEntityClass(), tid);
//      Queue queue= _uac.getDB().FindAssert(EN.QueueConfig.getEntityClass(), qid);

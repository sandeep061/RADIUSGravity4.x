 ...
 * @author Deepak
 */
public class GravityEntityExistsException extends GravityException
{
      private String _entityName;

    private String _condition;

    public GravityEntityExistsException(String entityname)
    {
        this._entityName = entityname;
    }

    public GravityEntityExistsException(String en, String condition)
    {
        this(en);
        setCondition(condition);
    }

    public GravityEntityExistsException(String en, String attrname, OPRelational ops, Object value)
    {
        this(en);
